...
- Include a new figure, `examples/timing-evaluation/out/llhd-comparison-2.png`
  which looks at the difference in the log-likelihood as calculated by each
  method as a function of the size of the dataset using a Bland-Altman plot and
  the size of the data set considered.
